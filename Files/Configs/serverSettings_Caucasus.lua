cfg = 
{
    ...
    ["missionList"] = 
    {
        [1] = "C:\\Users\\ecwadmin\\Saved Games\\DCS.openbeta_server\\ColdWar\\Files\\Missions\\Cold-War-Caucasus-SPLIT-v59INIT.miz",
    }, -- end of ["missionList"]
    ["password"] = "",
    ["listLoop"] = true,
    ["name"] = "Enigma's Dynamic Cold War Campaign PVP/PVE",
